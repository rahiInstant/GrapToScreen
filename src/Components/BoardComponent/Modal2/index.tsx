  ...
  return (
    <div class=" bg-[#2a2a3a] text-white rounded-md shadow-lg overflow-hidden z-[1000000] w-full h-full">
      ...
      <div class="p-4 flex justify-between items-center border-b border-gray-700 ">
        ...
        <div class="flex items-center gap-2">
          <button class="bg-[#ff5c5c] hover:bg-red-600 text-white text-xs px-3 py-1 rounded">
            Save
          </button>
        ...
        <div class=" p-4 h-full">
          <Show when={activeTab() === "connection"}>
            <div class="flex h-full">
              ...
              <div class="flex-1 pr-4">
                  ...
                  <div class="flex gap-2">
                    <label class="flex items-center gap-1 bg-[#333345] px-2 py-1 rounded cursor-pointer">
                      <input
                        ...
                        onChange={() => setConnectMethod("oauth2")}
                      />
                    ...
                    <label class="flex items-center gap-1 bg-[#333345] px-2 py-1 rounded cursor-pointer">
                      <input
                        ...
                        onChange={() => setConnectMethod("service")}
                      />
                ...
                <div class="mb-4">
                  ...
                  <p class="text-xs text-gray-400 mt-1">
                    In Gmail, use this URL above when prompted to enter an OAuth
              ...
              {/* Right guide section */}
              <div id="right" class="w-[300px] bg-[#252535] rounded p-4 h-full">
                ...
                <div class="text-xs text-gray-300 overflow-y-auto h-full">
                  ...
                  <ul class="list-disc pl-5 space-y-2">
                    ...
                    <li>
                      ...
                      Credentials. If you don't have a project yet, you'll need
                      to create a new one and select it.
                    </li>
                    <li>
                    ...
                    <li>
                      In Credentials, select + CREATE CREDENTIALS + OAuth client
                      ID.
                    </li>
                    <li>
                    ...
                    <li>
                      Under Authorized redirect URLs, select + ADD URI. Paste in
                      the OAuth redirect URL shown on the left.
                    </li>
                    <li>Select Create.</li>
                    <li>
                    ...
                    <li>
                      Back to Credentials, click on the credential in OAuth 2.0
                      Client IDs, and copy the Client ID and Client Secret.
                    </li>
                  </ul>
                  <p class="mt-2">
